...
def train():
    ...
    model_args, data_args, lora_args, training_args, remaining_args = parser.parse_args_into_dataclasses(return_remaining_strings=True)
    ...
    trainer = Trainer(target_r=lora_args.target_r, r=lora_args.lora_r, epoch_p=lora_args.epoch_p, model=model, tokenizer=tokenizer, args=training_args, **data_module)
